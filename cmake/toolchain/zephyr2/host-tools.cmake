...
set_ifndef(ZEPHYR2_SDK_INSTALL_DIR "$ENV{ZEPHYR2_SDK_INSTALL_DIR}")
set(ZEPHYR2_SDK_INSTALL_DIR ${ZEPHYR2_SDK_INSTALL_DIR} CACHE PATH "Zephyr SDK install directory")

if(NOT ZEPHYR2_SDK_INSTALL_DIR)
  # Until https://github.com/zephyrproject-rtos/zephyr/issues/4912 is
  # resolved we use ZEPHYR2_SDK_INSTALL_DIR to determine whether the user
  # wants to use the Zephyr SDK or not.
  return()
endif()

set(REQUIRED_SDK_VER 2.0.0)
set(TOOLCHAIN_VENDOR zephyr)
set(TOOLCHAIN_ARCH x86_64)

set(sdk_version_path ${ZEPHYR2_SDK_INSTALL_DIR}/sdk_version)
if(NOT (EXISTS ${sdk_version_path}))
  message(FATAL_ERROR
    "The file '${ZEPHYR2_SDK_INSTALL_DIR}/sdk_version' was not found. \
Is ZEPHYR2_SDK_INSTALL_DIR=${ZEPHYR2_SDK_INSTALL_DIR} misconfigured?")
endif()
...
You have version ${SDK_VERSION} (${ZEPHYR2_SDK_INSTALL_DIR}).
...
include(${ZEPHYR_BASE}/cmake/toolchain/zephyr2/${SDK_MAJOR_MINOR}/host-tools.cmake)
